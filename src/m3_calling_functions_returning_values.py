...
def test_sum_of_digits():
    ...
    # Test 3:
    expected = 20
    answer = sum_of_digits(3287)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)

    # Test 4:
    expected = 10
    answer = sum_of_digits(4321)
...
def fancy_sums_of_digits(n):
    ...
    x_power=n**1000
    y_power=n**999
    X=sum_of_digits(x_power)
    Y=sum_of_digits(y_power)
    power=X**Y
